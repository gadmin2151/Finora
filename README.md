...
Нативный клиент для Android 8+: HTTPS-вход на свой сервер, выбор организации, быстрый QR MEV, съёмка одного чека несколькими фотографиями, сохранение черновика, история и месячная статистика. Исходники, сборка подписанного APK, тесты и инструкция установки — в [android/README.md](android/README.md). Мобильный клиент использует тот же сервер и пользователей; дополнительный AI на телефоне не требуется.
...
- Чат внутри приложения: фото одного чека (до четырёх частей), камера телефона, QR на фото или ссылка MEV; история сообщений и карточки товаров.
...
Нативное мобильное приложение — следующая итерация. Нет банковской синхронизации, полноценного офлайн-режима, 2FA, автоматических курсов валют или текущих каталогов цен магазинов. Число организаций и администраторов не ограничено моделью «один владелец»; роли действуют отдельно в каждой организации.
