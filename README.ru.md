...
На сайте: **Настройки → Учёт денег**. На Android: **аватар → Учёт денег**. В режиме **«Всё вместе»** все счета MDL действительно объединяются в выбранный основной счёт: начальные остатки складываются, чеки, доходы, долги, переводы и планы переносятся, опустевшие счета удаляются. Суммы, категории и оригиналы сохраняются; повторные расходы не создаются. Новые операции используют единственный счёт. Создание отдельных счетов доступно после возврата к раздельному режиму; объединённая история при этом остаётся на основном счёте. Существующие другие валюты учитываются отдельно без автоматической конвертации.

На страницах **Обзор** и **Счета** нажмите **«Указать текущий остаток»** и введите сумму, которая у вас есть сейчас. Следующие доходы и расходы считаются от неё. Разница сохраняется отдельной корректировкой, не изменяя статистику доходов и расходов; начальный остаток и история не переписываются.
