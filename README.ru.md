...
По умолчанию сайт и Android следуют оформлению устройства. На сайте нажмите значок солнца/луны в верхней панели или откройте **Настройки → Оформление**. На телефоне нажмите аватар → **Оформление**. Доступны **Как в системе**, **Светлая** и **Тёмная**. Выбор сохраняется отдельно в каждом браузере и телефоне, включая повторный вход и смену организации. Камера остаётся тёмной, чтобы элементы управления были видны поверх изображения.
